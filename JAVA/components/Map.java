...
public class Map implements Utilities, MapPlan {
     ...
     */
    public Map(int junctionsNum,  SimulationController simulationController) {
        ...
        for (int i = 0; i < junctionsNum; i++) {
            if (getRandomBoolean()) {
                ...
                LightedJunction junc = new LightedJunction(simulationController);
                junctions.add(junc);
    ...
    public Map(SimulationController simulationController){
        junctions = new ArrayList<Junction>();
        roads = new ArrayList<Road>();
        lights = new ArrayList<TrafficLights>();
