 ...
 */
public class Road implements RouteParts, Drawable {
	...
	/**
	 * The drawing of the road - a black line
	 * @param g
	 */
	@Override
	public void draw(Graphics g) {
		g.setColor(Color.BLACK);
		g.drawLine((int)startJunction.getX(), (int)startJunction.getY(), (int)endJunction.getX(), (int)endJunction.getY());
	}
}
