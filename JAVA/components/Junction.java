 ...
 */
public class Junction extends utilities.Point implements RouteParts, Drawable, ColoredEntity {
	...
	public void checkIn(Vehicle vehicle){
		...
		if(vehicle.getDriver().getMyReports().size()>0) {
			vehicle.getBigBrother().getMoked().readReport(vehicle.getDriver(), vehicle.getDriver().getMyReports().get(0));
		}
	...
	/**
	 * Draw a junction with no trafficLight - a black oval
	 * @param g
	 */
	@Override
	...
	/**
	 * The color of the junction with no trafficLight - BLACK
	 * @return
	 */
	@Override
